...
if ($c->isEditMode() && $controller->isBlockEmpty()) {
    ...
    <div class="ccm-block-page-list-wrapper tallacmans-fancy">
        ...
        <div class="ccm-block-page-list-pages">
            ...
            foreach ($pages as $page) {
                ...
                <div class="<?php echo $entryClasses ?>">
                  ...
                  <div class="ccm-block-page-list-page-entry-image-spacer">

                    <h3 class="p-5" style='background-color: silver; text-align:center'>Missing Image</h3>
                            ...
                            <?php if (isset($includeName) && $includeName) {
                                ...
                                <div class="ccm-block-page-list-title">
                                    <?php if (isset($useButtonForLink) && $useButtonForLink) {
                                        ...
                                        ?>
                                        <h3><a href="<?php echo h($url) ?>"
                                           target="<?php echo h($target) ?>"><?php echo h($title) ?></a></h3>
                                        <?php
