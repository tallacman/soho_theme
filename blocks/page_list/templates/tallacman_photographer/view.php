...
if ($c->isEditMode() && $controller->isBlockEmpty()) {
    ...
    <div class="ccm-block-page-list-wrapper tallacman-photographer">
        ...
        <div class="ccm-block-page-list-pages">
            ...
            foreach ($pages as $page) {
                ...
                <div class="<?php echo $entryClasses ?>">
                  <h4><a href="<?php echo h($url) ?>" target="<?php echo h($target) ?>"><?php echo h($title); ?></a></h4>
                    ...
                    <?php if ($includeEntryText) {
                        ...
                        <div class="ccm-block-page-list-page-entry-text">
                            ...
                            <?php if (isset($includeDate) && $includeDate) {
                                ?>
                                <div class="ccm-block-page-list-date small"><?php echo h($date) ?></div>
                                <?php
                            } ?>
                            ...
                            <?php if (isset($useButtonForLink) && $useButtonForLink) {
                                ...
                                <div class="ccm-block-page-list-page-entry-read-more">
                                    <a href="<?php echo h($url) ?>" target="<?php echo h($target) ?>"
                                       class="<?php echo h($buttonClasses) ?> btn btn-primary"><?php echo h($buttonLinkText) ?></a>
                                </div>
                                <?php
                            } ?>
