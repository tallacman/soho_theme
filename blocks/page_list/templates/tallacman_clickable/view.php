...
if ($c->isEditMode() && $controller->isBlockEmpty()) {
    ...
    <div class="ccm-block-page-list-wrapper tallacman-clickable-page-list"> <!--   the big warpper  -->
            ...
            foreach ($pages as $page) {
                ...
                <div class="<?php echo $entryClasses ?>">
                    ...
                    <?php if ($includeEntryText) {
                        ?>
                        <div class="ccm-block-page-list-page-entry-text"> <!--   teh text wrapper  -->

                            <?php if (isset($includeName) && $includeName) {
                                ?>
                                <div class="ccm-block-page-list-title h4">
