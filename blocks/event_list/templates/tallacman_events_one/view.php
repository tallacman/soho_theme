...
if ($calendar) {
    ...
    if ($canViewCalendar) {
        ...
        ?>
    <div class="ccm-block-calendar-event-list-wrapper widget-featured-events unbound tallacman-event-list-base" data-page="<?= $totalPerPage ?: 3 ?>">
    ...
    if ($total = count($events)) {
        foreach ($events as $occurrence) {
            ...
            <div class="ccm-block-calendar-event-list-event">
              <div class="ccm-block-calendar-event-meta-data">

                <div class="ccm-block-calendar-event-list-event-date">
                    <span class="month-display"><?=$service->formatCustom('M', $occurrence->getStart())?></span>
                    <span class="day-display"><?=$service->formatCustom('d', $occurrence->getStart())?></span>
                    <span class="year-display"><?=$service->formatCustom('Y', $occurrence->getStart())?></span>
    ...
    ?>
            ...
            ?>
              ...
              </div> <!--   closed head meta data wrapper added by tallacman  -->
    ...
    ?>
            <button type="button" class="btn btn-dark" data-cycle="previous"><i class="fa fa-angle-left"></i></button>
                <button type="button" class="btn btn-dark" data-cycle="next"><i class="fa fa-angle-right"></i></button>
            <?php
